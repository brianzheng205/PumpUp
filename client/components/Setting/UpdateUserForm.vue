...
<template>
  ...
  <form @submit.prevent="updateUsername" class="pure-form">
    <fieldset>
      ...
      <button type="submit" class="pure-button pure-button-primary btn-primary">Update username</button>
    </fieldset>
  </form>
  ...
  <form @submit.prevent="updatePassword" class="pure-form">
    <fieldset>
      ...
      <button type="submit" class="pure-button pure-button-primary btn-primary">Update password</button>
    </fieldset>
  </form>
</template>
